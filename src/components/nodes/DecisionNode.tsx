  ...
  return (
    <div className="group relative w-32 h-32 flex items-center justify-center">
      ...
      <button
        ...
        className="absolute top-0 right-0 bg-white dark:bg-gray-800 rounded-full p-1 shadow-md opacity-0 group-hover:opacity-100 transition-opacity z-20 hover:bg-gray-100 dark:hover:bg-gray-700"
      >
